			...
			<div class="owl-stage-outer">
							...
							<div class="tyche-product orange">
								...
								<div class="tyche-product-body">
									...
									<span class="price"><span
										class="woocommerce-Price-amount amount"><fmt:formatNumber pattern="#,###,###,###">${fashion.getPrice()}</fmt:formatNumber> VNĐ</span></span> <a
										rel="nofollow"
				...
				<div aria-label="Page navigation">
					<ul class="pagination pagination-lg" id="fashion_pagination">
						...
						<c:if test="${pageFashionIndex == 1 }">
							<li class="page-item disabled" id="1"><a class="page-link"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
						</c:if>
						<c:if test="${pageFashionIndex > 1 }">
							<li class="page-item " id="${pageFashionIndex-1 }"><a class="page-link"
								aria-label="Previous"> <span aria-hidden="true">&laquo;</span>
							</a></li>
						</c:if>
						<c:forEach var="i" begin="1" end="${totalFashionPage}">
							<c:choose>
								<c:when test="${i == pageFashionIndex}">
						...
						<c:choose>
							<c:when test="${pageFashionIndex == totalFashionPage }">
							<li class="page-item disabled" id="${pageFashionIndex}"><a class="page-link"
